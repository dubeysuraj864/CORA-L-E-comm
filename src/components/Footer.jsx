...
function Footer() {
  return (
    <>
      <div className="footer p-5 md:p-10 bg-[#1B4B61] text-white flex md:flex-row flex-col justify-between">
        ...
        <div className="right flex flex-col justify-start items-center my-10">
            <div className="flex">
                <a href="#" target="_blank" rel="noopener noreferrer"><img className=" w-[50px] m-1 p-2" src={fb} alt="" /></a>
                <a href="#" target="_blank" rel="noopener noreferrer"><img className=" w-[50px] m-1 p-2" src={insta} alt="" /></a>
