      ...
      <nav className=" rounded-md px-5  text-[#1B4B66]">
        <div className="flex justify-between items-center py-4 md:mx-0">
          ...
          <section className="fixed z-10 md:static top-0 left-0">
            {show ? (
              <>
                <ul className=" bg-[url(https://img.freepik.com/free-vector/colorful-summer-background-zoom_23-2148582985.jpg)] md:bg-none w-[60vw] h-[110vh] pl-10 pt-5 transition-all text-white md:bg-transparent md:w-auto md:h-auto md:text-black md:p-0 md:flex md:items-center md:text-md">
                  <span
