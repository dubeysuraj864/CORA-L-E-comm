        ...
        {data &&
          data
            ...
            .map((x, index) => {
              return (
                <div
                  className="flex flex-col md:flex-row justify-center item-start"
                  key={index}
                >
                  <div
                    key={index}
            ...
            />
                  ...
                  <div className="right mx-10 md:m-5 md:w-[50%]">
                    <div className="title text-4xl  font-bold">{x.title}</div>
                    <div className="category my-2 text-gray-500 max-w-[500px]">
                      {x.description}
                    </div>
                    <div className="category my-2 font-bold text-gray-800 max-w-[500px]">
                      {x.category}
                    </div>
                    ...
                    <div className="price flex items-center my-4">
                      <div className="price-now mr-1 text-3xl font-bold ">
                        ${x.price}
                      </div>
